...
users = pd.read_csv('E:\\coldstart\\ml-100k\\u.user', sep='|', names=u_cols,encoding='latin-1')

#Reading ratings file:
r_cols = ['user_id', 'movie_id', 'rating', 'unix_timestamp']
ratings = pd.read_csv('E:\\coldstart\\ml-100k\\u.data', sep='\t', names=r_cols,encoding='latin-1')

#Reading items file:
i_cols = ['movie_id', 'movie_title' ,'release date','video release date', 'IMDb URL', 'unknown', 'Action', 'Adventure',
'Animation', 'Children\'s', 'Comedy', 'Crime', 'Documentary', 'Drama', 'Fantasy',
'Film-Noir', 'Horror', 'Musical', 'Mystery', 'Romance', 'Sci-Fi', 'Thriller', 'War', 'Western']
items = pd.read_csv('E:\\coldstart\\ml-100k\\u.item', sep='|', names=i_cols,
encoding='latin-1')
...
r_cols = ['user_id', 'movie_id', 'rating', 'unix_timestamp']
ratings_train = pd.read_csv('E:\\coldstart\\ml-100k\\ua.base',  sep='\t',names=r_cols, encoding='latin-1')
ratings_test = pd.read_csv('E:\\coldstart\\ml-100k\\ua.test', sep='\t', names=r_cols, encoding='latin-1')
...
def predictUserMovie(x):
  ...
  #    print(items.movie_title.iloc[getMovie(i, ratedData)])
      return x

def predictItemMovie(x):
   #print("Movies recommended for item \n")
   #print(movie_id.iloc[24])
   for i in range(5):       #          ................................... number of movies to predict
      print(items[items.movie_id == iItem[x][i]].movie_title)

predictUserMovie('24')      #         .........................This function takes user_id and predicts 5 MOVIES for the user.
print('==============================================')
predictItemMovie('24')      #          .........................This function takes movie_id and predicts 5 MOVIES for the user.
x = similarityPrediction(item_similarity)
